...
const TEMPLATE_FILE = 'MATERIAL ABRASION TEST NEW.docx';
const TEST_ID = 'SATRA-TM-31';
...
async function main() {
  ...
  console.log('Material abrasion template registered:', { templateKey, templatePath, test: rows[0] });
}
